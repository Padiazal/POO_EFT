...
public class Main {
    public static void main(String[] args) {
        ...
        //  nada especial en el main, solo la ejecucion
        //  trayendo metodos y atributos del resto del proyecto y  en paralelo portando los datos concretos a ingresar o modificar
        //  para generar la salida con los resultados esperados ( no se solicito interfaz grafica por lo que vi)
